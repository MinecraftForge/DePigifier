...
public class Matcher {
    ...
    public void computeClassListDifferences() {
        ...
        differenceSet(oldProguard::getClassNames, newProguard::getClassNames, getMapperFunction(IMapper::getClassNameTransformer), oldProguard::getClass, newProguard::getClass, (o,n)->n.setMatchedOldValue(o), ()->newClasses, ()-> existingClasses, ()-> missingClasses);
    ...
    public void compareExistingClasses() {
        ...
        existingClasses.stream().sorted(
                Comparator.comparing(aClass -> aClass.getMatchedOldValue().getObfName(),
    ...
    private void compareClass(final Class entry, final List<Field> newFieldTracked, final List<Method> newMethodTracked, final List<Field> missingFields, final List<Method> missingMethods) {
        ...
        differenceSet(old::getFieldNames, nw::getFieldNames, Function.identity(), old::getField, nw::getField, (o,n)->n.setMatchedOldValue(o),()->newFieldTracked, ArrayList::new, ()->missingFields);
        differenceSet(old::getMethodSignatures, nw::getMethodSignatures, Function.identity(), old::getMethod, nw::getMethod, (o,n)->n.setMatchedOldValue(o),()->newMethodTracked, ArrayList::new, ()->missingMethods);
    }
